import UIKit //  Created by Ivanov Viktor on 16.01.2021.
...
class SearchVC: UIViewController {
    ...
    func configureCallToActionButtonButton() {
        ...
        callToActionButton.addTarget(self, action: #selector(pushFavouritesVC), for: .touchUpInside)
