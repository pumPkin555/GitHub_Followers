...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createFavouritesNavigationController() -> UINavigationController {
        let favouritesNC = FavouritesVC()
        favouritesNC.title = "Favorites"
        favouritesNC.tabBarItem = UITabBarItem(tabBarSystemItem: .favorites, tag: 1)
        
        return UINavigationController(rootViewController: favouritesNC)
    }
